import { Pool as BasePool, PoolOptions } from 'mysql2/typings/mysql/lib/Pool';
import {
...
import {
  ...
  QueryOptions,
  QueryError,
} from 'mysql2/typings/mysql/lib/protocol/sequences/Query';
import {
  PoolCluster as BasePoolCluster,
  PoolClusterOptions,
  PoolNamespace,
} from 'mysql2/typings/mysql/lib/PoolCluster';
import { PoolConnection as BasePoolConnection } from 'mysql2/typings/mysql/lib/PoolConnection';
import {
  Prepare as BasePrepare,
  PrepareStatementInfo,
} from 'mysql2/typings/mysql/lib/protocol/sequences/Prepare';
...
export * from 'mysql2/typings/mysql/lib/protocol/packets';
export * from 'mysql2/typings/mysql/lib/Auth';
export * from 'mysql2/typings/mysql/lib/constants';
export * from 'mysql2/typings/mysql/lib/parsers';
